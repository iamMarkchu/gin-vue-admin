    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CategorySearch"
                        }
                    }
                ],
                "responses": {
        ...
        "/picture/getPictureList": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "分页获取Picture列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PictureSearch"
                        }
                    }
                ],
                "responses": {
